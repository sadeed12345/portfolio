    ...
    <div className="services" id='Services'>
        ...
        <div className="cards">
              ...
              style={{left:'14rem'}}>
                ...
                emoji = {HeartImoji}
                heading = {'DevOps'}
                detail = {"Aws, Docker, kubernetes, Zerotier, Hashicorp"}
                />
              </motion.div>
              ...
              style={{top: "12rem",left:'-4rem'}}>
                ...
                emoji = {Glasses}
                heading = {'Developer'}
                detail = {"Django, React, JavaScript, Node, python, GOlang"}
                />
              </motion.div>
              ...
              transition={{transition}}
               ...
               style={{top: "19rem",left:'12rem'}}>
                <Card
                emoji = {Humble}
                heading = {'Caching and Other'}
                detail = {"SQS, SES, firebase, Rabbit mq, Redis"}
                />
              </motion.div>
